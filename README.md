...
If there is anything else you would like added, just implement it in a good place, write the appropriate tests, and submit a pull request on [GitHub](https://github.com/kmalakoff/SubjectiveScript.m)
